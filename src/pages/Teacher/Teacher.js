                    ...
                    <Grid container direction="column">
                        <Grid item xs={12} sx={{ padding: { xs: 4, }, alignContent: 'center' }}>
                            <Typography variant='h4' fontWeight='bold' color={theme.palette.primary.main} sx={{ textAlign: 'center' }}>
                                Welcome {teacherData.name} To Teacher Dashboard!
                            </Typography><br />
                            ...
                            <Grid container spacing={3}>
                                ...
                                <Grid item xs={12} sm={6} md={4} lg={3}>
                                    <Card
                                        ...
                                        onClick={() => navigate('/create-paper-pattern')}
                                    >
                                        <CardContent>
                                            <Typography variant="h2" component="div" align="center" color={theme.palette.primary.main}>
                                                +
                                            </Typography>
                                            <Typography variant="subtitle1" component="div" align="center" fontWeight='bold' color={theme.palette.primary.main}>
