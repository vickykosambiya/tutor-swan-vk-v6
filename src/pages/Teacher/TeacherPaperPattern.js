...
const PaperPattern = () => {
    ...
    const handleSubmit = async (action) => {
        // Check for unique question pairs
        if (!isQuestionPairUnique) {
            alert('Each pair of main question number and sub question number must be unique.');
            return;
        }
        ...
        try {
            ...
            setIsLoading(false);
            console.error('Error updating paper pattern:', error);
    ...
    const [showUpdating, setShowUpdating] = useState(isLoading);
